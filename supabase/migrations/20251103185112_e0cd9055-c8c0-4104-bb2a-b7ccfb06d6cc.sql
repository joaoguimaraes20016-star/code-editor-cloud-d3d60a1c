-- Update the auto_create_confirmation_task function to calculate due_at from confirmation schedule
...
-- Recalculate due_at for existing tasks that have null due_at
...
SET due_at = (
  SELECT a.start_at_utc - (
    CASE 
      ...
      THEN CAST((t.confirmation_schedule->0->>'hours_before')::numeric || ' hours' AS INTERVAL)
